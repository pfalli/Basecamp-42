...
/*   Updated: 2021/08/08 19:12:36 by mschreib         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const static char	g_upper_left = 'A';
const static char	g_upper_right = 'C';
const static char	g_lower_left = 'A';
const static char	g_lower_right = 'C';
const static char	g_horizontal = 'B';
const static char	g_vertical = 'B';
