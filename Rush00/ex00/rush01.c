...
/*   Updated: 2021/08/08 19:11:10 by mschreib         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const static char	g_upper_left = '/';
const static char	g_upper_right = '\\';
const static char	g_lower_left = '\\';
const static char	g_lower_right = '/';
